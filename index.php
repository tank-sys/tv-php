...
.stream {width: 1200px; position: relative; }
#overlay {position: absolute; top: 10%; left: 25%; 
  font-weight: bold; font-size: 20px; background-color: rgba(180, 180, 180, 0.3);
  width: 50%; color: #fff; text-align: center;
  padding: 15px 0; z-index: 2147483647; border: 0px; border-radius: 35px; cursor: pointer;}
.mundur {
  z-index: 1;
}
</style>
...
<div class="row">
<div class="column">
<a href="<?php echo $_SERVER["PHP_SELF"];?>" style='font-size:65px; cursor:pointer; color: red;'>&#10173;</a>
</div>
<?php
for ($i=1; $i < $rowCount ; $i++) { 
echo "
...
<div class="tombol">
<button onclick="sidebar_open()" style="font-size:25px; border: 0px; background-color: black; cursor:pointer; color: white;">&#9776;</button><br>
<a href="<?php echo $_SERVER["PHP_SELF"];?>" style='font-size:35px; cursor:pointer; text-decoration:none; color: white;'>&#10173;</a>
</div>
<div class="frame">
...
";
$hasil .= "<center>
<video autoplay preload=\"auto\" controls width=\"1200px\" id=\"m3u\" class=\"video-js\">
...
for (var i = 0; i < tracks.length; i++) {
  ...
  if (track.kind === 'captions' && track.language === 'id') {
    track.mode = 'showing';
  }
}
...
klick to unmute
<script>
  <button id=\"overlay\" onclick=\"remdiv()\"><img src=\"/gambar/mute.png\" width=\"70px\" style=\"vertical-align:middle\">
  click to unmute!
  </button>
<script src=\"/aksesories/jquery-3.6.0.min.js\"></script>
